...
class SearchVC: UIViewController {
    ...
    var logoImgageViewTopConstraint: NSLayoutConstraint!
    ...
    func configureLogoImageView() {
        ...
        logoImgageViewTopConstraint = logoImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: topConstraintConstant)
        logoImgageViewTopConstraint.isActive = true
